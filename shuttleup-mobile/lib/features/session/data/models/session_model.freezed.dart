...
switch (_that) {
case _SessionModel():
return $default(_that.id,_that.title,_that.startTime,_that.endTime,_that.courtName,_that.maxPlayers,_that.bookedPlayers,_that.price,_that.requiredSkill);}
}
